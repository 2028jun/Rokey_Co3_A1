"""Convert ROS orthogonal route points into Isaac direct-drive stages."""
...
def build_axis_stages(
    ...
    *,
    ...
    """Build pivot/translation stages from an axis-aligned polyline.

    Every translation is forward-only.  ``planned_route`` prevents the Isaac
    controller from retargeting a ROS-planned coordinate to its legacy lane.
    """
    if len(points) < 2:
