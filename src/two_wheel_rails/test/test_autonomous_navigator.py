...
def test_fleet_lane_preserves_axis_aligned_route():
    ...
    shifted = navigator._apply_fleet_lane(points, preserve_orthogonal=True)
...
def test_fixed_route_mode_keeps_existing_lane_point_snap():
    navigator = _bare_navigator(robot_id="robot1")

    shifted = navigator._apply_fleet_lane(
        [(0.0, 5.0), (0.0, -2.2), (-1.17, -2.2)]
    )
