    ...
    def _park_out_if_needed(
        ...
        *,
        ...
        if not self._controller.drive_distance(
            ...
            # Do not raise: a sticky manager FAILED cancels the HMI order and
            # blocks the peer until reset_fault. Continue the kitchen return
            # from the current dock-side pose.
            self.get_logger().warning(
