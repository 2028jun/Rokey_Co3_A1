#!/usr/bin/env python3
"""Bridge Isaac two-wheel raw topics to /odom /scan and TF."""
...
class TopicBridge(Node):
    def __init__(self) -> None:
        super().__init__("map_gen_topic_bridge")
        ...
        self.get_logger().info(
            ...
            f"{RAW_SCAN_TOPIC} -> /scan"
        )

    def _on_teleport(self, _msg: PoseStamped) -> None:
        self._rebase_on_next_odom = True
        self.get_logger().info("teleport: will rebase /odom on next odom")
