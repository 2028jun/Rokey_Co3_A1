...
```bash
cd ~/git/Rokey_Co3_multi/map_generate
./tools/sync_assets.sh   # sibling nav_robot / nav_robot5 assets
...
| `t3` | `slam_patrol` — **테이블 뒤(OUTER=±2.55) · 화분 모서리(WALL=±3.85) · 주방/남쪽 문 앞 · 외곽 레인** + look-around |
